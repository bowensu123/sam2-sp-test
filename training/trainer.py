    ...
    def train_epoch(self, train_loader):
        ...
        for data_iter, batch in enumerate(train_loader):
            ...
            try:
                ...
                # Unscale + (SP) image-encoder grad sync + gradient clipping.
                # When SP is on, image-encoder grads are partial on each SP
                # rank after DDP's DP-group allreduce; summing them across
